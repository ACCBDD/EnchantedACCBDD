...
public class CircleMagicParticleType extends ParticleType<CircleMagicParticleType.CircleMagicData> {
	...
	).apply(instance, (type, red, green, blue, centerX, centerY, centerZ, radius) -> new CircleMagicData((ParticleType<CircleMagicData>)BuiltInRegistries.PARTICLE_TYPE.get(new ResourceLocation(type)), red, green, blue, centerX, centerY, centerZ, radius)));
