...
public class RiteProtectionObserver extends StateObserver {

	public final Block block;

	public RiteProtectionObserver(Level level, BlockPos pos, int radiusX, int radiusY, int radiusZ, Block block) {
