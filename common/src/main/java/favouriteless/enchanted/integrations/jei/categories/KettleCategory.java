...
public class KettleCategory implements IRecipeCategory<KettleRecipe> {
    ...
    public KettleCategory(IGuiHelper guiHelper) {
    ...
    public IDrawable getIcon() {
        return guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(EItems.KETTLE.get()));
    }

    @Override
    public RecipeType<KettleRecipe> getRecipeType() {
        return EJeiRecipeTypes.KETTLE;
    }
