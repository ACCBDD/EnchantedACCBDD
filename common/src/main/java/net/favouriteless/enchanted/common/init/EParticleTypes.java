...
import favouriteless.enchanted.client.particles.types.*;
...
import net.favouriteless.enchanted.client.particles.types.TwoToneColouredParticleType.TwoToneColouredData;
