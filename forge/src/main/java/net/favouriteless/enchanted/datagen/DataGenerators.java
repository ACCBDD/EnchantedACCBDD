package net.favouriteless.enchanted.datagen;

import net.favouriteless.enchanted.common.Enchanted;
import net.favouriteless.enchanted.datagen.providers.*;
import net.favouriteless.enchanted.datagen.providers.tag.*;
